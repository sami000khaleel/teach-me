...
router.post('/add_lecture',teacher_controller.add_lecture)
router.get('/download_lecture',teacher_controller.get_lectures_by_course)
router.get('/get_lectures',teacher_controller.get_lectures)
router.delete('/delete_lecture',teacher_controller.delete_lecture)
